...
import SliderTestimonials from "@/components/swipe-slide-testimonials"
import SliderCourses from "@/components/swipe-slide-courses"
import PromoCards from "@/components/prom-cards"
    ...
    <>
      ...
      <section class="w-full bg-[#FFFFFF]">
        ...
        <div className="container mx-auto px-4 py-24 flex flex-col  items-center">
          ...
          <SliderCourses />
          <button class="mt-16 text-sm bg-[#FFFFFF] text-[#265FF1] border-[#265FF1] border-solid border px-[22px] py-3.5 rounded-lg hover:bg-gray-200">Explora todos los cursos</button>
      ...
      <section class="w-full bg-[#FFFFFF]">
        ...
        <div className="container mx-auto px-4 py-24 flex flex-col  items-center">
          ...
          <h1 className="text-3xl lg:text-5xl font-bold text-center mb-16 text-[#000D59]">
            Miles de personas<br />confían en nosotros
          </h1>
          {/* <TestimonialsCarousel /> */}
          <SliderTestimonials />
        </div>
